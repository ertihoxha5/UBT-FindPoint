...
export const getAdminUsers = (params?: { search?: string; status?: string }) => api.get('/admin/users', { params });
...
export const getAdminItems = (params?: { search?: string; moderationStatus?: string; type?: string }) =>
